odoo.define('web.search_filters', function (require) {
    ...
    var DateTime = Field.extend({
        ...
        operators: [
            ...
            {value: "∄", text: _lt("is not set")},
            //custom
            {value: "Today", text: _lt("Today")},//date = hom nay
            {value: "Less than days ago", text: _lt("Less than days ago")},//Loc ra ban ghi co today-x < date < today
            {value: "More than days ago", text: _lt("More than days ago")},//Loc ra ban ghi co date < today-x
            {value: "Days Ago", text: _lt("Days Ago")},//Loc ra ban ghi co date = today -x
            {value: "Is less than", text: _lt("Is less than(days)")},//loc ra cac ban ghi co today < date < today + x
            {value: "Is more than", text: _lt("Is more than(days)")},//Lọc ra các bản ghi có date > today + x
            {value: "Days Later", text: _lt("Days Later")}//Lọc ra các bản ghi có date = today + x
            //end custom
        ],
        ...
        get_domain: function (field, operator) {
            switch (operator.value) {
                ...
                case 'Today':
                    ...
                    this["datewidget_" + (97)].setValue(date_start);
                    return [[field.name, '>=', this.get_value(0)], [field.name, '<=', this.get_value(97)]];
                ...
                case 'Less than days ago':
                    ...
                    this["datewidget_" + (97)].setValue(date_end);
                    return [[field.name, '>', this.get_value(0)], [field.name, '<', this.get_value(97)]];
        ...
        show_inputs: function ($operator) {
            ...
            else if ($operator.val() === "Less than days ago") {
                this._hide_datewidget();
            ...
            else if ($operator.val() === "More than days ago") {
                this._hide_datewidget();
                this._show_input_integer();
                if (this.datewidget_1) {
                    this.datewidget_1.do_hide();
            ...
            else if ($operator.val() === "Is less than") {
                this._hide_datewidget();
                this._show_input_integer();
                if (this.datewidget_1) {
                    this.datewidget_1.do_hide();
            ...
            else if ($operator.val() === "Is more than") {
                this._hide_datewidget();
                this._show_input_integer();
                if (this.datewidget_1) {
                    this.datewidget_1.do_hide();
                }
            } else if ($operator.val() === "Days Later") {
                this._hide_datewidget();
                this._show_input_integer();
                if (this.datewidget_1) {
                    this.datewidget_1.do_hide();
    ...
    var Date = DateTime.extend({
        ...
        get_value: function (index) {
            ...
            //this["datewidget_" + (index || 0)].setValue(this.get_value_number());
